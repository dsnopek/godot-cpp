...
bool Example::has_object_instance_binding() const {
	return ::godot::interface::object_get_instance_binding(_owner, ::godot::interface::token, nullptr);
}
...
String Example::test_library_path() {
	String library_path;
	::godot::interface::get_library_path(::godot::interface::library, library_path._native_ptr());
	return library_path;
}
